...
#define STM32_USB_EPR(n)             (STM32WB_USB1_BASE+STM32_USB_EPR_OFFSET(n))
#define STM32_USB_EP0R               (STM32WB_USB1_BASE+STM32_USB_EP0R_OFFSET)
#define STM32_USB_EP1R               (STM32WB_USB1_BASE+STM32_USB_EP1R_OFFSET)
#define STM32_USB_EP2R               (STM32WB_USB1_BASE+STM32_USB_EP2R_OFFSET)
#define STM32_USB_EP3R               (STM32WB_USB1_BASE+STM32_USB_EP3R_OFFSET)
#define STM32_USB_EP4R               (STM32WB_USB1_BASE+STM32_USB_EP4R_OFFSET)
#define STM32_USB_EP5R               (STM32WB_USB1_BASE+STM32_USB_EP5R_OFFSET)
#define STM32_USB_EP6R               (STM32WB_USB1_BASE+STM32_USB_EP6R_OFFSET)
#define STM32_USB_EP7R               (STM32WB_USB1_BASE+STM32_USB_EP7R_OFFSET)

/* Common Registers */

#define STM32_USB_CNTR               (STM32WB_USB1_BASE+STM32_USB_CNTR_OFFSET)
#define STM32_USB_ISTR               (STM32WB_USB1_BASE+STM32_USB_ISTR_OFFSET)
#define STM32_USB_FNR                (STM32WB_USB1_BASE+STM32_USB_FNR_OFFSET)
#define STM32_USB_DADDR              (STM32WB_USB1_BASE+STM32_USB_DADDR_OFFSET)
#define STM32_USB_BTABLE             (STM32WB_USB1_BASE+STM32_USB_BTABLE_OFFSET)

/* Buffer Descriptor Table (Relatative to BTABLE address) */

#define STM32_USB_BTABLE_ADDR(ep,o)  (STM32WB_USB1_PMAADDR+STM32_USB_BTABLE_RADDR(ep,o))
